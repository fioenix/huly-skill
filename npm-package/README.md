...
`huly_whoami`, `huly_list_projects`, `huly_list_tasks`, `huly_get_task`, `huly_create_task`, `huly_update_task`, `huly_delete_task`, `huly_report`, `huly_list_labels`, `huly_create_label`, `huly_assign_label`, `huly_show_labels`, `huly_list_teamspaces`, `huly_list_documents`, `huly_read_document`, `huly_create_document`, `huly_create_teamspace`, `huly_list_milestones`, `huly_create_milestone`, `huly_complete_milestone`.
